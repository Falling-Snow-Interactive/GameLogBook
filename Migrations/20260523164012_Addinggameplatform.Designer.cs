...
namespace GameLogBook.Migrations
{
    ...
    [Migration("20260523164012_Addinggameplatform")]
    partial class Addinggameplatform
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameLogBook.Models.Games.Game", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Ownership", "GameLogBook.Models.Games.Game.Ownership#List<GamePlatform>", b1 =>
                        {
                            b1.IsRequired();
