...
{
    /// <inheritdoc />
    public partial class UseGameCompanyIdArrays : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                                 ...
                                 FROM "Games", json_each("Games"."DeveloperCompanyIds") AS "developer";
                                 """);

            migrationBuilder.Sql("""
                                 INSERT OR IGNORE INTO "GameCompanies" ("GameId", "CompanyId", "Role")
                                 SELECT "Games"."Id", CAST("publisher"."value" AS INTEGER), 2
                                 FROM "Games", json_each("Games"."PublisherCompanyIds") AS "publisher";
                                 """);
